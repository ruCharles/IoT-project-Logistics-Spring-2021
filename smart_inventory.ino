...
// Prepare key - all keys are set to FFFFFFFFFFFFh at chip delivery from the factory.
  ...
  Serial.println(F(" Escribe la fecha de caducidad del producto y termina con un punto . "));
  ...
  Serial.println(F(" Escribe el nombre del producto o SKU y termina con un punto . "));
